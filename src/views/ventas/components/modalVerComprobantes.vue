        ...
        <el-card shadow="hover">
          ...
          <el-row>
            ...
            <el-col :span="8">
              ...
              <el-row>
                ...
                <el-row>
                  <el-col :span="10"><el-form-item label="IMPORTES NO GRAVADOS :"
                      class="formItem1"></el-form-item></el-col>
              ...
              <div class="columnaIva">
                ...
                <el-row :gutter="20">
                  ...
                  <el-col :span="2">
                    ...
                    <el-select placeholder="MENDOZA" v-model="formulario.invoice.invoice_jurisdiction"
                      class="uniform-input" size="mini">
                      <el-option v-for="item in selectJurisdiccion" :key="item.jurisdiction_id"
                        :label="item.jurisdiction_name" :value="item.jurisdiction_name"></el-option>
                    </el-select>
                  </el-col>
                </el-row>
                <el-row :gutter="20">
          ...
          <div class="columnaMedio">
            <el-form-item class="formItem1" label="TOTAL :">
              <el-input @input="" type="text" v-model="formulario.invoice.total_amount" class="uniform-input"
                size="default" readonly></el-input>
            </el-form-item>
            <el-form-item label="RUBRO :">
              <el-select size="mini" v-model="formulario.invoice.heading" @change="varControl(formulario.invoice.heading)"
                class="uniform-input" placeholder="Rubros">
            ...
            <el-form-item label="Tipo Gasto :">
              <el-select size="mini" v-model="formulario.invoice.expense_type"
                @change="varControl(formulario.invoice.expense_type)" class="uniform-input" placeholder="Tipo Gasto">
                <el-option v-for="item in tablaRubrosDelFinal" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          ...
          <div class="classDeBotones">
            <el-button @click="updateData()" size="medium" type="success">Guardar</el-button>
          </div>
        </el-card>
      </el-form>
    </div>
 ...
 */            this.fillTableIva(this.row.taxes[i])
    ...
    async calcularTotal() {
      ...
      this.formulario.invoice.total_amount = (Number(this.neto) + Number(this.iva) +
        ...
        Number(this.formulario.taxes[9].value)).toFixed(2)
      console.log("total_amount", this.formulario.invoice.total_amount);
    },
