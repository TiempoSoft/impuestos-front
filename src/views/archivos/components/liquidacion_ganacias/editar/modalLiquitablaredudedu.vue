  ...
  <div class="app-container">
    ...
    <el-card style="height: 30px">
      ...
      <div class="col-5-close closeModal">
        <el-button
          @click="$modal.hide('Modaltablaredudedu')"
    ...
    <div class="row">
      <el-card>
        ...
        <div class="row">
          <div class="col-10">
            <label for="">
              Reduccion sobre el importe total de deducciones personales:</label
            >
          </div>
          <div class="col-8">
            <el-input
    ...
    <div class="row">
      <div class="col-16">
        <el-button type="danger" @click="$modal.hide('Modaltablaredudedu')"
          >Cerrar</el-button
        >
      </div>
      <div class="col-25">
        <el-button type="primary" @click="Actuaizarcrud()">Aceptar</el-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    Actuaizarcrud() {
      ...
      Axios.put("http://localhost:3000/redudedu/", this.formalario_crud).then(
        (result) => {
