...
export default {
  ...
  methods :{
    handleClick(datos) {
      datos = "datos"    
      this.$modal.hide("CuentaDeudoresEditar");
    },
    handleCurrentChange(val) {
      this.currentRow = val;
      this.codigo = val.cuenta;
      this.descrip = val.descrip;
      this.$store.state.b.DescripCuentaDeudoresEdit = this.descrip
      console.log("imputa ",this.CuentaDeudores);
      this.CuentaDeudores.imputacion = this.codigo;
    },
  },
  created() {
