  ...
  <div class="app-container">
    <el-card style="height: 30px">
      ...
      <div class="col-5-close closeModal">
        <el-button
          @click="$modal.hide('ModalNuevoResponsable')"
          ...
          <div class="col-75">
            <div class="row">
              ...
              <div class="col-25" style="width: 15%; margin-left: -3%">
                <input
                  maxlength="4"
                  type="text"
                  @input ="CodigoParaCrearNuevoCliente()"
                  v-model.number="formulario.nrocli"
                  disabled
                />
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-25" style="width: 45%; margin-left: -3%">
                <input maxlength="30" type="text" v-model="formulario.apeynom" />
              </div>
            </div>
            <div class="row">
              <div class="col-20"></div>
              ...
              <div class="col-25" style="width: 45%; margin-left: -1%">
                <input maxlength="30" type="text" v-model="formulario.domicilio" />
              </div>
            </div>
            <div class="row">
              <div class="col-20"></div>
              ...
              <div class="col-25" style="width: 45%; margin-left: -1%">
                <input maxlength="30" type="text" v-model="formulario.localidad" />
              </div>
            </div>
            <div class="row">
              <div class="col-20"></div>
              ...
              <div class="col-25" style="width: 30%; margin-left: -7%">
                <input maxlength="13" type="text" v-model="formulario.nrocuit" />
              </div>
            </div>
            <div class="row">
              <div class="col-20"></div>
              ...
              <div class="col-25" style=" margin-left: -4%">
                <input type="text" maxlength="5" @input="CodigoAct" v-model.number="formulario.cod_act" />
              </div>
               <div class="col-5" >
            ...
            <div class="row">
              ...
              <div class="col-25" style=" margin-left: -4%">
                <input type="text" @input="CodigoSedes" maxlength="3" v-model.number="formulario.dependenci" />
              </div>
               <div class="col-5" >
            ...
            <div class="row">
              ...
              <div class="col-15" style=" margin-left: -4%">
                <input type="text" maxlength="1" v-model="formulario.autonomo" />
              </div>
            </div>
          </div>
        </div>
    ...
    <el-card
      ><div style="margin-left: 60%">
        <el-button class="button" size="medium" @click="Enviardatos()"
          >Aceptar</el-button
        >
        <el-button
          class="button"
...
components :{TablaActs ,SedesDgi},
  ...
  methods: {
    ...
    VaciarCamposDeStore(){
      this.$store.state.a.CodigoTipoActs = ""
      this.$store.state.a.CodigoTipoSede = ""
    },
    CodigoParaCrearNuevoCliente() {
      console.log(this.DatosCliente);
      var maximo = 0;
      for (let i = 0; i < this.DatosCliente.length; i++) {
        let x = this.DatosCliente[i].nrocli;
        this.codigo.push(x);       
        for (let i = 0; i <= this.DatosCliente.length; i++) {
          console.log("x2",x);
      ...
      this.formulario.nrocli = maximo + 1;
      console.log("form",this.DatosCliente);
    },
    ActualizarAdb() {
       Axios.post("http://localhost:3000/cliente/" , this.formulario)
          .then((result) => {
            ...
            if (result.status === 201) {
              ...
              this.$modal.hide('ModalNuevoResponsable')
            }
          }) 
    },
  },
    created() {
      ...
      this.DatosCliente = result.data;
      console.log("datos_clientes", this.DatosCliente);
  ...
  computed : {
    CodigoSedes(){
      this.formulario.dependenci = this.$store.state.a.CodigoTipoSedes;
      this.formulario.cod_act = this.$store.state.a.CodigoTipoActs
    },
  },
 beforeUpdate() {
    this.CodigoParaCrearNuevoCliente();
