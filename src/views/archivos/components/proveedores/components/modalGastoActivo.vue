...
export default {
  ...
  methods :{
    Verdatos(){
      console.log(this.CuentaDeudores);
    },
    handleClick(datos) {
      datos = "datos"
      this.$emit("click", this.handleClick);      
      this.$modal.hide('modalGastoActivo') || this.$modal.hide('modalGastoActivoEditar')
    },
    handleCurrentChange(val) {
      this.todosLosDatos = val;
      this.currentRow = val.descrip;
      this.$store.state.e.CodigoCuentaGastoActivo = val.cuenta;
      this.$store.state.e.DescripCuentaGastoActivo = this.currentRow;     
    },
  },
  created() {
