<template>
  <div class="app-container">
    ...
    <el-card style="height: 40%">
      <div class="row">
        <div class="col-20" style="margin-left: 21%">
      ...
      <div class="row">
        <div class="col-20" style="margin-left: 21%">
          <el-radio v-model="radio" label="1">Por fecha del Comprob.</el-radio>
        </div>
        <div class="col-5">
      ...
      <div class="row">
        <div class="col-5" style="margin-left: 25%">
        ...
        <div style="margin-left: 28%">
          <el-checkbox-group v-model="checkList" :max="2">
            ...
            <el-checkbox style="margin-left: 5%" label="Incluye la CAI."></el-checkbox>
          </el-checkbox-group>
        </div>
      </div>
      <div class="row">
        <div class="col-5" style="margin-left: 21%">
          <label>Período:</label>
        </div>
        <div class="col-15">
          <el-input id="suma" type="text" />
