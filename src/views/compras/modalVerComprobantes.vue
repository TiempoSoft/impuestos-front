<template>
  ...
  <div class="main-content">
    ...
    <div class="classDeBotones">
      ...
      <el-button @click="sendData()" size="medium" type="success" class="float-left">Proveedor</el-button>
      <el-button @click="sendData()" size="medium" type="success" class="float-left">Borrar</el-button>
